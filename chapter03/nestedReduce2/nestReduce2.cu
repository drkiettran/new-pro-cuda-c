...
{
    std::cout << "nestedReduce2 program starts ..." << std::endl;
    ...
    initialData(h_A, nxy);
    initialData(h_B, nxy);
    std::cout << "Initialize Matrices on Host: " << GetDurationInMicroSeconds(begin, StopTimer()) << " mcs" << std::endl;
    ...
    std::cout << "Sum Matrices on Host: " << GetDurationInMicroSeconds(begin, StopTimer()) << " mcs" << std::endl;
    ...
    std::cout << "Sum Matrices 2D on GPU: " << GetDurationInMicroSeconds(begin, StopTimer()) << " mcs" << std::endl;
