...
int main(int argc, char** argv)
{
    ...
    initialData(h_A, nxy);
    initialData(h_B, nxy);
    std::cout << "Initialize Data on Host: " << GetDurationInMilliSeconds(begin, StopTimer()) << " ms" << std::endl;
    ...
    std::cout << "Sum Matricies on Host: " << GetDurationInMilliSeconds(begin, StopTimer()) << " ms" << std::endl;
